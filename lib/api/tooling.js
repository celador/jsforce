 ...
 * Executes Apex tests synchronously
 *
 * @param {String} ClassId - The Id of the Apex class to run the tests for.
 * @param {Array.<String>} testMethods - Comma separated list of class Names
 * @param {Callback.<Tooling~ExecuteAnonymousResult>} [callback] - Callback function
 * @returns {Promise.<Tooling~ExecuteAnonymousResult>}
 */
Tooling.prototype.runUnitTests = function(classId, testMethods, callback) {
  var url = this._baseUrl() + "/runTestsSynchronous/";
  return this._conn.requestPost(url, {tests: [{classId: classId, testMethods: testMethods}]}, undefined, callback);
};
